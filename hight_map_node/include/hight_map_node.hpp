...
private:
  ...
  void boundary_map_callback(const sensor_msgs::msg::PointCloud2::ConstSharedPtr msg);
  ...
  rclcpp::Subscription<sensor_msgs::msg::PointCloud2>::SharedPtr boundary_map_suber_;
  ...
  sensor_msgs::msg::PointCloud2 boundary_map_;
